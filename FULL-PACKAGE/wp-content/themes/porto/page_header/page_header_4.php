...
<div class="container<?php echo ! $hide_title ? '' : ' hide-title'; ?>">
	<div class="row align-items-center justify-content-end">
		<div class="col-lg-6<?php echo ! $hide_title ? '' : ' d-none'; ?>">
			<?php $tag = porto_breadcrumb_tag(); ?>
			<<?php echo porto_filter_output( $tag ) ?> class="page-title<?php echo ! $sub_title ? '' : ' b-none'; ?>"><?php echo porto_strip_script_tags( $title ); ?></<?php echo porto_filter_output( $tag ) ?>>
			<?php
			if ( $sub_title ) :
				?>
		...
		<?php if ( $breadcrumbs ) : ?>
			<div class="breadcrumbs-wrap col-lg-6<?php echo ! $sub_title ? '' : ' breadcrumbs-with-subtitle'; ?>">
