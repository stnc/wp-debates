{
	...
	"mainmenu-toplevel-hbg-color":"var(--porto-primary-color)",
	"mainmenu-toplevel-config-active":0,
	"mainmenu-toplevel-alink-color":"#ffffff",
	"mainmenu-toplevel-abg-color":"var(--porto-primary-color)",
	...
	"mainmenu-popup-border-color":"var(--porto-primary-color)",
	...
	"footer-ribbon-bg-color":"var(--porto-primary-color)",
