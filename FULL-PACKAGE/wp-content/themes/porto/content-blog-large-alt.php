...
<article <?php post_class( $post_class ); ?>>
	...
	<div class="post-content">
		...
		if ( ! $slideshow_type ) {
			...
			porto_get_template_part( 'views/posts/post-media/' . sanitize_file_name( $slideshow_type ) );
		?>
		...
		if ( 'yes' == $share || ( empty( $share ) && $social_share ) ) :
			?>
			<?php if ( isset( $porto_settings['blog-post-share-position'] ) && 'advance' !== $porto_settings['blog-post-share-position'] ) : ?>
