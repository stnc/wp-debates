...
<?php if ( $b['search-border-radius'] ) : ?>
	...
	<?php endif; ?>
	#header .searchform input { border-radius: <?php echo porto_filter_output( $rtl ? '0 20px 20px 0' : '20px 0 0 20px' ); ?>; padding: <?php echo porto_filter_output( $rtl ? '0 20px 0 15px' : '0 15px 0 20px' ); ?>; }
	#header .searchform button { border-radius: <?php echo porto_filter_output( $rtl ? '20px 0 0 20px' : '0 20px 20px 0' ); ?>; padding: <?php echo porto_filter_output( $rtl ? '0 13px 0 16px' : '0 16px 0 13px' ); ?>; }
	/*#header .searchform .autocomplete-suggestions { left: 15px; right: 15px; }*/

	#header .searchform select,
	#header .searchform .selectric .label { line-height: inherit; padding: <?php echo porto_filter_output( $rtl ? '0 10px 0 15px' : '0 15px 0 10px' ); ?>; }
<?php endif; ?>
...
<?php elseif ( 'reveal' == $b['search-layout'] ) : ?>
	...
	#header .search-popup .search-toggle { display: inline-block; }
	#header .search-popup .searchform { display: none; position: absolute; top: 0; z-index: 1003; border-radius: 0; border: none; left: 0; right: 0; height: 100%; margin-top: 0; box-shadow: none; }
	#header .search-popup .searchform .searchform-fields { transition: opacity 0.8s, clip-path cubic-bezier(0.215, 0.61, 0.355, 1)  0.8s,-webkit-clip-path cubic-bezier(0.215, 0.61, 0.355, 1) 0.8s; opacity: 0; visibility: hidden; -webkit-clip-path: polygon(40% 0%,60% 0%,60% 100%,40% 100%); clip-path: polygon(40% 0%,60% 0%,60% 100%,40% 100%); }
	.porto-search-opened #header .search-popup .searchform .searchform-fields { visibility: visible; opacity: 1; -webkit-clip-path: polygon(0% 0%,100% 0%,100% 100%,0% 100%); clip-path: polygon(0% 0%,100% 0%,100% 100%,0% 100%); }
	#header .searchform .searchform-fields {  position: absolute; left: 0; width: 100%; height: 100%; align-items: center; padding: 0 <?php echo (int) $b['grid-gutter-width'] / 2; ?>px; }
	...
	<?php if ( ! empty( $b['searchform-border-color'] ) ) { ?>
		border-bottom-color: <?php echo esc_html( $b['searchform-border-color'] ); ?>; 
	<?php } ?>
	}
	#header .searchform input::placeholder { font-size: 22px; }
	#header .searchform .text { flex: 1; }
	#header .searchform .selectric-cat { display: none; }
	#header .searchform .button-wrap { display: flex; align-items: center; position: absolute; <?php echo porto_filter_output( $right ); ?>: <?php echo ( 20 + (int) $b['grid-gutter-width'] / 2 ); ?>px; }
	#header .searchform .btn-close-search-form { font-size: 20px;<?php echo ! $b['searchform-hover-color'] ? '' : 'color: ' . esc_html( $b['searchform-hover-color'] ); ?> }
	#header .searchform-popup .search-toggle:after { content: none }
	#header .searchform button { padding: 0 5px; font-size: 16px; }
	#header .searchform .button-wrap .porto-icon-magnifier::before { content: "\f002"; font-family: var(--fa-style-family-classic, "Font Awesome 6 Free"); font-weight: 900; }
<?php elseif ( 'overlay' == $b['search-layout'] ) : ?>
	#header .search-popup .search-toggle { display: inline-block; min-width: 25px; }
	#header .search-popup .searchform { display: flex; position: fixed; top: 100%; z-index: 1003; border-radius: 0; border: none; left: 0; width: 100vw !important; height: 100vh !important; margin-top: 0; box-shadow: none; flex-direction: column; justify-content: center; padding-left: var(--porto-column-spacing); padding-right: var(--porto-column-spacing); visibility: hidden; opacity: 0; transition: top 0.3s, visibility 0.3s, opacity 0.3s; }
	.porto-search-opened #header .search-popup .searchform { top: 0; opacity: 1; visibility: visible; }
	#header .searchform .searchform-fields { align-items: center; position: static; padding-left: 0; padding-right: 0 }
	#header .searchform .live-search-list { position: static; width: 100%; max-width: var(--porto-container-width); margin: 0 auto }
	#header .searchform input, #header .searchform select, #header .searchform .selectric, #header .searchform .selectric .label, #header .searchform button { border-width: 0; height: 44px; line-height: 44px }
	#header .searchform input { max-width: none; width: 100% !important; font-size: 22px; padding: 0 15px; border-radius: 0; }
	#header .searchform .selectric-cat,
	#header .searchform .text,
	#header .searchform .button-wrap { border-bottom: 2px solid <?php echo esc_html( $b['searchform-border-color'] ); ?>; }
	#header .searchform .text { flex: 1; }
	#header .searchform .btn-close-search-form { position: absolute; <?php echo porto_filter_output( $right ); ?>: 30px; top: 20px; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center }

	#header .searchform .btn-close-search-form { font-size: 20px;<?php echo ! $b['searchform-hover-color'] ? '' : 'color: ' . esc_html( $b['searchform-hover-color'] ); ?> }

	#header .searchform button { font-size: 1rem; padding: 0 5px; }
	#header .searchform-popup .search-toggle:after { content: none }
<?php elseif ( 'large' == $b['search-layout'] ) : ?>
	<?php if ( $b['searchform-bg-color'] ) : ?>
		#header .searchform-popup .search-toggle:after {
			border-bottom-color: <?php echo esc_html( $b['searchform-bg-color'] ); ?>;
		}
	<?php endif; ?>
<?php else : ?>
	#header .searchform button { font-size: 16px; padding: 0 15px; }
<?php endif; ?>
<?php if ( ! empty( $b['sticky-searchform-popup-border-color'] ) && ( 'large' == $b['search-layout'] || 'advanced' == $b['search-layout'] ) ) : ?>
	#header.sticky-header .search-popup .searchform { border-color: <?php echo esc_html( $b['sticky-searchform-popup-border-color'] ); ?> !important; }
	#header.sticky-header .searchform-popup .search-toggle:after { border-bottom-color: <?php echo esc_html( $b['sticky-searchform-popup-border-color'] ); ?> !important; }
	@media (max-width: 991px) {
		#header.sticky-header .searchform { border-color: <?php echo esc_html( $b['sticky-searchform-popup-border-color'] ); ?> !important; }
	}
<?php endif; ?>
...
<?php if ( 1 == $header_type || 4 == $header_type || 9 == $header_type || 13 == $header_type || 14 == $header_type || 17 == $header_type ) : ?>
	@media (min-width: 992px) {
		...
		#header.sticky-header .menu-right > *:not(:first-child),
		#header.sticky-header .menu-right .header-contact > *:not(:first-child) { margin-<?php echo porto_filter_output( $left );?>: 0.875rem; }
	}
<?php endif; ?>

/* mini cart */

<?php if ( 1 == $header_type || 4 == $header_type || 7 == $header_type || 8 == $header_type || 9 == $header_type ) : ?>
	...
	.header-main .header-contact > *:not(:first-child) {
		margin-<?php echo porto_filter_output( $left ); ?>: 0.875rem;
	}
<?php endif; ?>
<?php
	$minicart_type = porto_get_minicart_type();
?>
<?php if ( 'simple' == $minicart_type ) : ?>
...
<?php if ( class_exists( 'Woocommerce' ) ) : ?>
	...
	<?php if ( ! empty( $porto_settings['woo-show-default-page-header'] ) && $porto_settings['woo-show-default-page-header'] ) : ?>
		...
		.page-header-8 li a { color: <?php echo porto_if_light( '#222529', '#eee' ); ?>; font-family: 'Poppins', <?php echo sanitize_text_field( isset( $b['h3-font']['font-family'] ) ? $b['h3-font']['font-family'] : $b['body-font']['font-family'] ); ?>, sans-serif; text-decoration: none;  font-size: 1.25rem; font-weight: 700; letter-spacing: -.03em; transition: opacity .3s; vertical-align: middle; }
...
<?php if ( 1 == $header_type || 2 == $header_type || 9 == $header_type ) : ?>
	...
	#header .header-top .porto-view-switcher .narrow .inner > ul.sub-menu { border: 1px solid <?php echo porto_if_light( '#ccc', '#222529' ); ?> }
...
<?php elseif ( 2 == $header_type ) : ?>
	...
	@media (min-width: 992px) {
		#header .header-main .mega-menu { display: inline-flex; }
	}
	#header:not(.sticky-header) .header-main .mega-menu:after { content: ''; position: absolute; height: 24px; top: 50%; <?php echo porto_filter_output( $right ); ?>: 0; transform: translateY( -50% ); border-<?php echo porto_filter_output( $right ); ?>: 1px solid #dde0e2; }
	...
	#header .searchform-popup .search-toggle { margin: 0 .5rem; }

<?php elseif ( 3 == $header_type ) : ?>
	#header .searchform-popup .search-toggle { font-size: 20px; line-height: 40px; }
...
<?php elseif ( 6 == $header_type ) : ?>
	...
	#header .main-menu { text-align: inherit; white-space: nowrap; flex-wrap: nowrap; }
...
<?php elseif ( 7 == $header_type ) : ?>
	...
	#header .header-main .header-contact { font-size: 16px; line-height: 36px; 
		border-<?php echo porto_filter_output( $right ); ?>-color: rgba(255, 255, 255, 0.3); }
...
<?php elseif ( 9 == $header_type ) : ?>
	...
	@media (max-width: 991px) { #header .header-minicart >*:first-child { margin-<?php echo porto_filter_output( $left ); ?>: 0.875rem; } }
/* classic header type */
<?php elseif ( ( (int) $header_type >= 10 && (int) $header_type <= 17 ) || empty( $header_type ) ) : ?>
	...
	<?php if ( 'simple' != $b['search-layout'] && 'reveal' != $b['search-layout'] && 'overlay' != $b['search-layout'] ) : ?>
		#header .searchform { box-shadow: 0 1px 1px rgba(0, 0, 0, .075) inset; }
		#header .searchform select,
		...
		#header .searchform select { border-<?php echo porto_filter_output( $left ); ?>: 1px solid var(--porto-searchform-border-color,#ccc); padding-<?php echo porto_filter_output( $left ); ?>: 8px; margin-<?php echo porto_filter_output( $right ); ?>: -3px; font-size: 13px; }
		#header .searchform .selectric { border-<?php echo porto_filter_output( $left ); ?>: 1px solid var(--porto-searchform-border-color, #ccc); }
...
<?php if ( 10 == $header_type ) : ?>
	...
	#header .search-toggle i:before { content: "\f002"; font-family: var(--fa-style-family-classic, "Font Awesome 6 Free"); font-weight: 900; }
	@media (max-width: 991px) {
		#header .header-right-bottom { margin-top: 0; margin-bottom: 0; }
		#header .header-right-bottom .mobile-toggle { margin-<?php echo porto_filter_output( $right ); ?>: 0; }
	}
	@media (max-width: 575px) {
	...
	#header #mini-cart { margin-<?php echo porto_filter_output( $left ); ?>: 0.5rem; }
	<?php if ( ! isset( $b['minicart-type'] ) || 'minicart-inline' != $b['minicart-type'] ) : ?>
		#mini-cart .cart-head { font-size: 14px; line-height: 1; }
	<?php endif; ?>
	#mini-cart .cart-items { font-size: 0.5em; }
	@media (min-width: 992px) {
		...
		<?php if ( 'overlay' != $b['search-layout'] ): ?>
			#header .searchform { margin-<?php echo porto_filter_output( $left ); ?>: 15px; }
		<?php endif; ?>
	}
	#header .searchform-popup .search-toggle { font-size: 14px; }
<?php endif; ?>
...
<?php if ( 11 == $header_type || 12 == $header_type ) : ?>
	@media (min-width: 992px) {
		...
		#header .porto-narrow-sub-menu ul.sub-menu { border-radius: 0; }
...
<?php endif; ?>
<?php if ( 11 <= $header_type && $header_type <= 16 ) : ?>
	@media (min-width: 992px) {
		<?php if ( 'minicart-inline' != $b['minicart-type'] ) : ?>
			#mini-cart .cart-head { font-size: 14px; line-height: 1; }
		<?php endif; ?>
		#mini-cart .cart-items { font-size: 0.5em; }
		#header .searchform-popup { line-height: 1; }
		#header .searchform-popup .search-toggle { font-size: .8rem; margin-<?php echo porto_filter_output( $left ); ?>: 8px; }
	}
<?php endif; ?>
...
<?php elseif ( 18 == $header_type ) : ?>
	...
	.header-main .header-right > div > *:not(:first-child) { margin-<?php echo porto_filter_output( $left ); ?>: 0.875rem; }
	#mini-cart .cart-items { background-color: #b7597c; }
...
<?php elseif ( 19 == $header_type ) : ?>
	...
	#header.header-19 .searchform-popup .search-toggle { color: <?php echo esc_html( $b['header-top-link-color']['regular'] ); ?>; font-size: 20px; }
	...
	<?php if ( isset( $b['minicart-type'] ) && 'none' != $b['minicart-type'] && class_exists( 'Woocommerce' ) ) : ?>
		#mini-cart { padding: 5px 0; ?>; line-height: 38px; border-<?php echo porto_filter_output( $left ); ?>: 1px solid rgba(255, 255, 255, 0.15) }
		...
		#mini-cart .minicart-icon { border-bottom: 18px solid; border-top: none; border-left: 1px solid transparent; border-right: 1px solid transparent; width: 18px; position: relative; margin-right: 6px; border-radius: 0; }
...
<?php elseif ( 'side' == $header_type ) : ?>
	...
	@media (min-width: 992px) {
		...
		<?php if ( 'advanced' == $b['search-layout'] ) : ?>
			...
			.header-wrapper #header .searchform input { padding: 0 10px; border-width: 0; width: 100%; }
			.header-wrapper #header .searchform .text { flex: 1 }
	...
	<?php if ( class_exists( 'Woocommerce' ) ) : ?>
		...
		#header .header-minicart > a { display: inline-block; font-size: 20px; text-align: center; margin-<?php echo porto_filter_output( $right ); ?>: .5rem; }
		#mini-cart .cart-head { font-size: 20px; text-transform: uppercase; }
		#mini-cart.minicart-inline .cart-subtotal { font-size: 13px; font-weight: 500; margin-<?php echo porto_filter_output( $left ); ?>: 1px; }
	...
	@media (max-width: 991px) {
		...
		#header .mobile-toggle {
			margin-<?php echo porto_filter_output( $left ); ?>: 0.875rem;
			margin-<?php echo porto_filter_output( $right ); ?>: 0.875rem !important;
		}
...
elseif ( empty( $header_type ) && porto_header_type_is_side() ) :
	...
	<?php endif; ?>
		...
		<?php else : ?>
			...
			.admin-bar #header { min-height: calc(100vh - 32px); top: 32px; }
	...
	<?php if ( ! $side_mobile_visible ) : // default side layout ?>
		...
		<?php endif; ?>
			...
			.side-header-narrow-bar-top + #header.side-header-visible { <?php echo porto_filter_output( $side_position ); ?>: 0 !important; }
...
<?php if ( porto_header_type_is_side() && 'columns' == $b['side-menu-type'] ) : ?>
	...
	.header-side-nav .sidebar-menu .narrow ul.sub-menu:after { content: ''; position: absolute; bottom: calc( 100% - 1px); height: 50vh; width: calc(100% + 2px); left: -1px; background-color: inherit; border-width: 0 1px 0 1px; border-style: solid; border-color: inherit; }
	.header-side-nav .sidebar-menu .wide .popup > .inner:after,
	.header-side-nav .sidebar-menu .narrow ul.sub-menu:after { bottom: auto; top: calc( 100% - 1px); }
...
<?php 
$container_xl = 1140;
$container_sl = (int) $b['container-width'];
if ( (int) $b['container-width'] < 1360 ) {
	$container_xl = (int) $b['container-width'];
	$container_sl = 1360;
}
?>
@media (min-width: <?php echo (int) ( $container_xl + $b['grid-gutter-width'] ); ?>px) {
	.ccols-xl-2 > * {
		--porto-cw: 50%;
	}
	.ccols-xl-3 > * {
...
@media (min-width: <?php echo (int) ( $container_sl + 2 * $b['grid-gutter-width'] ); ?>px) {
	.ccols-sl-10 > * {
		--porto-cw: 10%;
	}
	.ccols-sl-9 > * {
...
@media (max-width: <?php echo ( (int) $container_xl + (int) $b['grid-gutter-width'] - 1 ); ?>px) {
...
<?php if ( class_exists( 'Woocommerce' ) ) : ?>
	<?php if ( $dark ) : ?>
		...
		.cart-v2 .card-default .card-body, .card { background: <?php echo esc_html( $color_dark_5 ); ?> }
		.cart-v2 .card-default { border-radius: 0 0 6.99px 6.99px }
...
<?php if ( ! empty( $b['form-field-bw'] ) && ( ! empty( $b['form-field-bw']['top'] ) || ! empty( $b['form-field-bw']['right'] ) || ! empty( $b['form-field-bw']['bottom'] ) || ! empty( $b['form-field-bw']['left'] ) || ( isset( $b['form-field-bw']['top'] ) && '0' === $b['form-field-bw']['top'] ) || ( isset( $b['form-field-bw']['right'] ) && '0' === $b['form-field-bw']['right'] ) || ( isset( $b['form-field-bw']['bottom'] ) && '0' === $b['form-field-bw']['bottom'] ) || ( isset( $b['form-field-bw']['left'] ) && '0' === $b['form-field-bw']['left'] ) ) ) : ?>
...
<?php endif; ?>
<?php if ( isset( $b['form-br'] ) && ( ! empty( $b['form-br'] ) || '0' == $b['form-br'] ) ) : ?>
...
<?php if ( 17 == $header_type ) : ?>
	...
	#header .main-menu-wrap .menu-right .searchform-popup { display: inline-block; }
	<?php if ( 'advanced' == $b['search-layout'] ) : ?>
...
<?php if ( isset( $porto_settings['header-main-padding'] ) && ( '' != $porto_settings['header-main-padding']['padding-top'] || '' != $porto_settings['header-main-padding']['padding-bottom'] ) ) : ?>
	...
	.fixed-header #header .header-main .header-right,
	.fixed-header #header .header-main .header-center,
	.header-builder-p .header-main:not(.e-con) { padding-top: <?php echo (int) $porto_settings['header-main-padding']['padding-top']; ?>px; padding-bottom: <?php echo (int) $porto_settings['header-main-padding']['padding-bottom']; ?>px }
	.header-main.e-con {
		--padding-block-start: <?php echo (int) $porto_settings['header-main-padding']['padding-top']; ?>px;
		--padding-block-end: <?php echo (int) $porto_settings['header-main-padding']['padding-bottom']; ?>px;
	}
<?php endif; ?>
<?php if ( isset( $porto_settings['header-main-padding-mobile'] ) && ( '' != $porto_settings['header-main-padding-mobile']['padding-top'] || '' != $porto_settings['header-main-padding-mobile']['padding-bottom'] ) ) : ?>
	@media (max-width: 991px) {
		...
		.fixed-header #header .header-main .header-right,
		.fixed-header #header .header-main .header-center,
		.header-builder-p .header-main:not(.e-con) { padding-top: <?php echo (int) $porto_settings['header-main-padding-mobile']['padding-top']; ?>px; padding-bottom: <?php echo (int) $porto_settings['header-main-padding-mobile']['padding-bottom']; ?>px }
		.header-main.e-con {
			--padding-block-start: <?php echo (int) $porto_settings['header-main-padding-mobile']['padding-top']; ?>px;
			--padding-block-end: <?php echo (int) $porto_settings['header-main-padding-mobile']['padding-bottom']; ?>px;
		}
	}
<?php endif; ?>
<?php
...
<?php if ( $b['mainmenu-popup-bg-color'] ) : ?>
	...
	<?php if ( isset( $b['submenu-arrow'] ) && $b['submenu-arrow'] ) : ?>
		.top-links > li.has-sub:before,
		.top-links > li.has-sub:after {
			border-bottom-color: <?php echo esc_html( $b['mainmenu-popup-bg-color'] ); ?>;
		}
		.sidebar-menu .popup:before {
			border-right-color: <?php echo esc_html( $b['mainmenu-popup-bg-color'] ); ?>;
		}
	<?php endif; ?>
...
<?php if ( ! empty( $b['mainmenu-wrap-padding-sticky'] ) ) : ?>
...
<?php if ( $b['border-radius'] && ( empty( $b['mainmenu-bg-color'] ) || 'transparent' == $b['mainmenu-bg-color'] ) && ( empty( $b['mainmenu-toplevel-hbg-color'] ) || 'transparent' == $b['mainmenu-toplevel-hbg-color'] ) ) : ?>
	...
	.main-menu-wrap .porto-narrow-sub-menu,
	.main-menu-wrap .pos-left .porto-narrow-sub-menu,
	.main-menu-wrap .pos-right .porto-narrow-sub-menu { border-radius: 0 0 2px 2px; }
<?php endif; ?>
...
#header .main-menu > li.menu-item > a {
	<?php if ( ! empty( $b['menu-font']['font-family'] ) ) : ?>
...
<?php
	...
	$main_menu_level1_active_color = $b['mainmenu-toplevel-config-active'] ? $b['mainmenu-toplevel-alink-color'] : ( isset( $b['mainmenu-toplevel-link-color']['hover'] ) ? $b['mainmenu-toplevel-link-color']['hover'] : ( $main_menu_level1_abg_color ? 'var(--porto-primary-color-inverse)' : '' ) );
?>
...
#header .main-menu > li.menu-item:hover > a {
	<?php if ( $b['mainmenu-toplevel-hbg-color'] ) : ?>
		background-color: <?php echo esc_html( $b['mainmenu-toplevel-hbg-color'] ); ?>;
	<?php endif; ?>
	<?php if ( ! empty( $b['mainmenu-toplevel-link-color']['hover'] ) ) : ?>
		color: <?php echo esc_html( $b['mainmenu-toplevel-link-color']['hover'] ); ?>;
	<?php elseif ( $b['mainmenu-toplevel-hbg-color'] ) : ?>
...
.porto-popup-menu .sub-menu {
	<?php if ( ! empty( $b['menu-popup-font']['font-family'] ) ) : ?>
...
<?php if ( ( (int) $header_type >= 1 && (int) $header_type <= 9 ) || 18 == $header_type || 19 == $header_type || ( ( 'side' == $header_type || empty( $header_type ) ) && class_exists( 'Woocommerce' ) ) ) : ?>
	...
	<?php if ( $b['mainmenu-popup-heading-color'] ) : ?>
		--porto-heading-color: <?php echo esc_html( $b['mainmenu-popup-heading-color'] ); ?>;
	<?php endif; ?>
	}
<?php else : ?>
	.sidebar-menu .porto-wide-sub-menu > li > a,
...
<?php if ( $b['mainmenu-popup-border'] ) : ?>
	...
	#header .sidebar-menu .wide .popup, #header .sidebar-menu .narrow .popup { border-<?php echo empty( $porto_settings['header-side-position'] ) ? 'left' : 'right'; ?>: <?php echo esc_attr( $b['mainmenu-popup-border'] ); ?> solid <?php echo esc_attr( $b['mainmenu-popup-border-color'] ); ?>; }

	#header .main-menu > li.has-sub:before,
	#header .main-menu > li.has-sub:after {
		border-bottom-color: <?php echo esc_attr( $b['mainmenu-popup-border-color'] ); ?>;
	}
	#header .sidebar-menu .popup:before {
		border-right-color: <?php echo esc_attr( $b['mainmenu-popup-border-color'] ); ?>;
	}
<?php endif; ?>
<?php if ( ! $b['mainmenu-popup-border'] ) : ?>
	#header .main-menu .wide .popup,
...
<?php if ( ! empty( $b['show-account-dropdown'] ) ) : ?>
	...
	<?php if ( $b['account-dropdown-bgc'] ) : ?>
		...
		.account-dropdown > li.has-sub:before,
		.account-dropdown > li.has-sub:after {
			border-bottom-color: <?php echo esc_html( $b['account-dropdown-bgc'] ); ?>;
		}
	<?php endif; ?>
...
<?php if ( ! empty( $b['show-account-dropdown'] ) ) : ?>
	...
	#header .account-dropdown > li.menu-item > a { padding: 0; line-height: 1 }
...
<?php endif; ?>
<?php if ( $b['searchform-text-color'] || $b['searchform-bg-color'] ) : ?>
...
<?php endif; ?>
<?php if ( $b['searchform-popup-border-color'] && ( 'large' == $b['search-layout'] || 'advanced' == $b['search-layout'] ) ) : ?>
...
@media <?php echo porto_filter_output( $screen_large ); ?> {
	#header .main-menu-wrap .menu-custom-block .tip {
		<?php echo porto_filter_output( $right ); ?>: <?php echo ( int ) porto_config_value( $b['mainmenu-toplevel-padding2'][ 'padding-' . $right ] ) - 5; ?>px;
		top: <?php echo ( int ) porto_config_value( $b['mainmenu-toplevel-padding2']['padding-top'] ) - 15; ?>px;
	}
	#header .main-menu > li.menu-item > a/*,
	#header .menu-custom-block span,
...
<?php if ( porto_header_type_is_side() ) : ?>
	@media (min-width: 992px) {
		...
		<?php if ( isset( $b['side-menu-type'] ) && ! ( 'slide' == $b['side-menu-type'] || 'accordion' == $b['side-menu-type'] ) ) :?>
		...
		.side-nav-right .porto-narrow-sub-menu li.menu-item-has-children>a:before { float: <?php echo porto_filter_output( $left ); ?>; content: "\f053" }
		.page-wrapper.side-nav-right .sidebar-menu li.menu-item>.arrow:before { content: "\e819" }

		.side-nav-right #header .sidebar-menu li.menu-item > .arrow { <?php echo porto_filter_output( $right ); ?>: auto; <?php echo porto_filter_output( $left ); ?>: 10px; transition: <?php echo porto_filter_output( $left ); ?> .25s; }
		.side-nav-right #header .sidebar-menu li.menu-item:hover > .arrow { <?php echo porto_filter_output( $right ); ?>: auto; <?php echo porto_filter_output( $left ); ?>: 5px; }
		...
		.side-nav-right .side-menu-columns .narrow .menu-item-has-children:hover>a:after, 
		.side-nav-right .side-menu-columns>.menu-item-has-children:hover>a:after {
			<?php echo porto_filter_output( $right ); ?>: auto; <?php echo porto_filter_output( $left ); ?>: 12px;
		}
		<?php endif; ?>
		<?php endif; ?>
	}
...
<?php if ( isset( $b['minicart-icon-font-size'] ) && $b['minicart-icon-font-size'] ) : ?>
	...
	?>
	#mini-cart .cart-head { font-size: <?php echo esc_html( $b['minicart-icon-font-size'] ); ?> }
<?php endif; ?>
<?php if ( isset( $b['minicart-popup-border-color'] ) && $b['minicart-popup-border-color'] ) : ?>
	...
	#mini-cart.minicart-text .cart-head:after { border-color: <?php echo esc_html( $b['minicart-popup-border-color'] ); ?>; }
<?php endif; ?>
<?php if ( isset( $b['sticky-minicart-popup-border-color'] ) && $b['sticky-minicart-popup-border-color'] ) : ?>
	...
	<?php endif; ?>
	.sticky-header #mini-cart .cart-icon:after,
	.sticky-header #mini-cart.minicart-text .cart-head:after { border-color: <?php echo esc_html( $b['sticky-minicart-popup-border-color'] ); ?>; }
<?php endif; ?>
...
/* mobile panel */
<?php
	$panel_link_color = empty( $b['panel-link-color']['regular'] ) ? ( 'side' == $b['mobile-panel-type'] ? ( ! empty( $b['panel-bg-color'] ) && '#ffffff' == $b['panel-bg-color'] ? '#222529' : '#fff' ) : '#333' ) : $b['panel-link-color']['regular'];
?>
<?php if ( ! empty( $b['panel-bg-color'] ) ) : ?>
	...
	?>
	 { background-color: <?php echo esc_html( $b['panel-bg-color'] ); ?>;
		<?php
			if ( 'side' == $b['mobile-panel-type'] && '#ffffff' == $b['panel-bg-color'] && ('#ffffff' == $b['panel-link-color']['regular'] || empty( $b['panel-link-color']['regular'] ) ) ) :
				echo 'color: ' . esc_html( $panel_link_color ) . ';';
			endif;
		?>
	}
	<?php
	...
	?>
	 { background-color: <?php echo '#ffffff' == $b['panel-bg-color'] ? esc_html( $porto_color_lib->darken( $b['panel-bg-color'], 3.2 ) ) : esc_html( $porto_color_lib->lighten( $b['panel-bg-color'], 5 ) ); ?>; }
<?php endif; ?>
...
<?php if ( $b['panel-border-color'] ) : ?>
	<?php
	if ( 'side' == $b['mobile-panel-type'] ) :
		echo '#side-nav-panel .accordion-menu li:not(:last-child), #side-nav-panel .accordion-menu.porto-view-switcher li';
	else :
...
<?php if ( empty( $b['mobile-panel-type'] ) ) : ?>
	...
	.page-wrapper { transition: left .3s }
...
<?php elseif ( 'side' == $b['mobile-panel-type'] ) : ?>
	<?php
	if ( ! empty( $b['panel-tab-color']['regular'] ) ) {
		echo '#side-nav-panel .mobile-tabs .mobile-tab-item:not(.active) { color:' . esc_html( $b['panel-tab-color']['regular'] ) . '; }';
	}
	if ( ! empty( $b['panel-tab-color']['active'] ) ) {
		echo '#side-nav-panel .mobile-tabs .mobile-tab-item.active { color:' . esc_html( $b['panel-tab-color']['active'] ) . '; border-bottom-color:' . esc_html( $b['panel-tab-color']['active'] ) .'; }';
	}
	?>
	#side-nav-panel .accordion-menu li.menu-item > a,
	#side-nav-panel .menu-custom-block a,
	#side-nav-panel .accordion-menu li.menu-item > .arrow { color: <?php echo esc_html( $panel_link_color ); ?>; }
	...
	?>
	.page-wrapper,
	#header.sticky-header .header-main.sticky { transition: left .3s }
	html.panel-opened .page-wrapper,
	html.panel-opened #header.sticky-header .header-main.sticky { left: <?php echo 'left' == $mobile_panel_pos ? '260px' : '-260px'; ?>; }
	...
	<?php if ( isset( $b['mobile-panel-add-search'] ) && $b['mobile-panel-add-search'] ) : ?>
		@media (max-width: 991px) {
			...
			#side-nav-panel .searchform-fields {
				...
				background: <?php 
					if ( '#ffffff' == $b['panel-bg-color'] ) {
						echo '#f4f4f4';
					} else {
						echo esc_html( $porto_color_lib->lighten( $b['panel-bg-color'], 5 ) );
					}
				?>;
			}
			#side-nav-panel .searchform .text { flex: 1; }
			#side-nav-panel .searchform input[type="text"] { width: 100%; height: 38px; background: none; border: none; font-size: inherit; padding-<?php echo porto_filter_output( $left ) ?>: 25px; }
...
<?php if ( ! empty( $b['panel-link-color']['hover'] ) ) : ?>
	<?php if ( empty( $b['mobile-panel-type'] ) ) : ?>
		...
		#nav-panel .accordion-menu li.menu-item:hover > .arrow,
	...
	<?php else : ?>
		...
		#side-nav-panel .accordion-menu li.menu-item:hover > .arrow { color: <?php echo esc_html( $b['panel-link-color']['hover'] ); ?>; }
	<?php endif; ?>
<?php endif; ?>
...
.main-sidebar-menu .sidebar-menu .menu-custom-block a {
	<?php if ( ! empty( $b['menu-side-font']['font-family'] ) ) : ?>
...
<?php if ( $b['mainmenu-toplevel-hbg-color'] ) : ?>
	...
	<?php if ( 'transparent' != $b['mainmenu-toplevel-hbg-color'] ) : ?>
		.side-nav-wrap .sidebar-menu > li.menu-item > a,
		.side-nav-wrap .sidebar-menu > li.menu-item:hover + li.menu-item > a,
...
<?php endif; ?>
<?php if ( isset( $b['breadcrumbs-delimiter-font'] ) && ( ! empty( $b['breadcrumbs-delimiter-font'] ) || '0' == $b['breadcrumbs-delimiter-font'] ) ) : ?>
...
<?php endif; ?>
<?php if ( ! empty( $b['breadcrumbs-text-transform'] ) ) : ?>
	.page-top ul.breadcrumb>li {
		text-transform: <?php echo esc_html( $b['breadcrumbs-text-transform'] ); ?>;
	}
<?php endif; ?>
.page-top .breadcrumb {
...
<?php if ( class_exists( 'Woocommerce' ) ) : ?>
	...
	@media (min-width: 768px) and (max-width: <?php echo ( (int) $container_xl + (int) $b['grid-gutter-width'] - 1 ); ?>px) {
...
<?php if ( ! empty( $porto_settings_optimize['lazyload_menu'] ) ) : ?>
	...
	.menu-item.narrow .sub-menu.skeleton-body { min-width: 165px; }
...
<?php if ( defined( 'ELEMENTOR_VERSION' ) ) : ?>
	...
	@media (min-width: <?php echo 1140 + (int) $b['grid-gutter-width']; ?>px) and (max-width: <?php echo (int) $b['container-width'] + 2 * (int) $b['grid-gutter-width'] - 1; ?>px) {
		.elementor-section { --porto-flick-carousel-width: 1140px; }
		.e-con { --container-max-width: 1140px; }
		.elementor-section.elementor-section-boxed > .elementor-container { max-width: 1140px; --porto-flick-carousel-width: 1140px; }
		.elementor-section.elementor-section-boxed > .elementor-column-gap-no { max-width: <?php echo 1140 - (int) $b['grid-gutter-width']; ?>px; --porto-flick-carousel-width: <?php echo 1140 - (int) $b['grid-gutter-width']; ?>px; }
		.elementor-section.elementor-section-boxed > .elementor-column-gap-narrow { max-width: <?php echo 1140 - (int) $b['grid-gutter-width'] + 10; ?>px; --porto-flick-carousel-width: <?php echo 1140 - (int) $b['grid-gutter-width'] + 10; ?>px; }
		.elementor-section.elementor-section-boxed > .elementor-column-gap-extended { max-width: <?php echo 1140 - (int) $b['grid-gutter-width'] + 30; ?>px; --porto-flick-carousel-width: <?php echo 1140 - (int) $b['grid-gutter-width'] + 30; ?>px; }
		.elementor-section.elementor-section-boxed > .elementor-column-gap-wide { max-width: <?php echo 1140 - (int) $b['grid-gutter-width'] + 40; ?>px; --porto-flick-carousel-width: <?php echo 1140 - (int) $b['grid-gutter-width'] + 40; ?>px; }
		.elementor-section.elementor-section-boxed > .elementor-column-gap-wider { max-width: <?php echo 1140 - (int) $b['grid-gutter-width'] + 60; ?>px; --porto-flick-carousel-width: <?php echo 1140 - (int) $b['grid-gutter-width'] + 60; ?>px }
	}
	...
	<?php endif; ?>
	{
		...
		.elementor-section.elementor-section-boxed > .elementor-column-gap-no { max-width: <?php echo 960 - (int) $b['grid-gutter-width']; ?>px; --porto-flick-carousel-width: <?php echo 960 - (int) $b['grid-gutter-width']; ?>px }
		.elementor-section.elementor-section-boxed > .elementor-column-gap-narrow { max-width: <?php echo 960 - (int) $b['grid-gutter-width'] + 10; ?>px; --porto-flick-carousel-width: <?php echo 960 - (int) $b['grid-gutter-width'] + 10; ?>px; }
		.elementor-section.elementor-section-boxed > .elementor-column-gap-extended { max-width: <?php echo 960 - (int) $b['grid-gutter-width'] + 30; ?>px; --porto-flick-carousel-width: <?php echo 960 - (int) $b['grid-gutter-width'] + 30; ?>px }
		.elementor-section.elementor-section-boxed > .elementor-column-gap-wide { max-width: <?php echo 960 - (int) $b['grid-gutter-width'] + 40; ?>px; --porto-flick-carousel-width: <?php echo 960 - (int) $b['grid-gutter-width'] + 40; ?>px; }
		.elementor-section.elementor-section-boxed > .elementor-column-gap-wider { max-width: <?php echo 960 - (int) $b['grid-gutter-width'] + 60; ?>px; --porto-flick-carousel-width: <?php echo 960 - (int) $b['grid-gutter-width'] + 60; ?>px; }
	}
...
<?php endif; ?>
/*---------------- Sticky Icon Bar ---------------- */
<?php if ( ! empty( $porto_settings['show-icon-menus-mobile'] ) ) : ?>
