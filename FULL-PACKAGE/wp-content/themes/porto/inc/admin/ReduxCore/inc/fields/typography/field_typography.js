...
(function( $ ) {
                ...
                el.each(
                    function() {
                        ...
                        $( this ).find( '.redux-typography-color' ).wpColorPicker(
                            {
                                palettes: [ 'var(--porto-primary-color)', 'var(--porto-secondary-color)', 'var(--porto-tertiary-color)', 'var(--porto-quaternary-color)', 'var(--porto-dark-color)', 'var(--porto-light-color)', 'var(--porto-primary-light-5)' ],
    ...
    redux.field_objects.typography.select = function( selector, skipCheck ) {
        ...
        } else if ( redux.fonts.custom && family in redux.fonts.custom ) {
            details = redux.fonts.custom[family];
        } else {
            details = {
                '400': 'Normal 400',
                '700': 'Bold 700',
