...
<header id="header" class="header-corporate header-11<?php echo empty( $porto_settings['logo-overlay'] ) || empty( $porto_settings['logo-overlay']['url'] ) ? '' : ' logo-overlay-header'; ?>">
	...
	<div class="header-main">
		<div class="container">
			...
			<div class="header-right">
				...
				<a <?php echo apply_filters( 'porto_mobile_toggle_data_attrs', '' ); ?> aria-label="Mobile Menu" href="#" class="mobile-toggle<?php echo ( isset( $porto_settings['menu-toggle-bg-color'] ) && $porto_settings['menu-toggle-bg-color'] ) ? ' background-color-primary text-color-light' : ''; ?>"><i class="fas fa-bars"></i></a>
			</div>
		</div>
