...
class sidebar_generator {
	...
	public static function admin_page() {
		...
		<style>
			...
			#widgets-editor .interface-interface-skeleton {
				position: relative;
				top: 0;
				left: 0;
				height: 100vh;
		...
		<div style="display: block;padding: 16px;border-bottom: 1px solid #f0f0f0;">
			<div class="wrap">
				<h2><?php esc_html_e( 'Sidebar Generator', 'porto' ); ?></h2>
				<p><?php esc_html_e( 'The sidebar name is for your use only. It will not be visible to any of your visitors. A CSS class is assigned to each of your sidebar, use this styling to customize the sidebars.', 'porto' ); ?>
				</p>
				<br />
