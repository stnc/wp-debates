...
/**
 * Get Breadcrumb Tag from Theme option
 * 
 * @since 7.1.0
 */
function porto_breadcrumb_tag() {
	global $porto_settings;
	if ( ! empty( $porto_settings['breadcrumb_tag'] ) && isset( $porto_settings['breadcrumb_pages'] ) && is_array( $porto_settings['breadcrumb_pages'] ) ) {
		if ( porto_is_product_archive() || porto_is_shop() ) {
			return in_array( 'shop', $porto_settings['breadcrumb_pages'] ) ? $porto_settings['breadcrumb_tag'] : 'h1';
		} elseif ( porto_is_product() ) {
			return in_array( 'sproduct', $porto_settings['breadcrumb_pages'] ) ? $porto_settings['breadcrumb_tag'] : 'h1';
		} elseif ( porto_is_archive() || is_home() ) {
			return in_array( 'archive', $porto_settings['breadcrumb_pages'] ) ? $porto_settings['breadcrumb_tag'] : 'h1';
		} elseif ( is_single() ) {
			return in_array( 'single', $porto_settings['breadcrumb_pages'] ) ? $porto_settings['breadcrumb_tag'] : 'h1';
		} else {
			return in_array( 'pages', $porto_settings['breadcrumb_pages'] ) ? $porto_settings['breadcrumb_tag'] : 'h1';
		}
	}
	return 'h1';
}
