...
if ( ! class_exists( 'ReduxFramework_color_gradient' ) ) {
	...
	class ReduxFramework_color_gradient {
		...
		public function render() {
			...
			echo '<div class="colorGradient"><strong>' . esc_html__( 'From ', 'redux-framework' ) . '</strong>&nbsp;';
			...
			echo '</div>';
			echo '<div class="colorGradient toLabel"><strong>' . esc_html__( 'To ', 'redux-framework' ) . '</strong>&nbsp;<input data-id="' . $this->field['id'] . '" id="' . $this->field['id'] . '-to" name="' . $this->field['name'] . $this->field['name_suffix'] . '[to]' . '" value="' . $this->value['to'] . '" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['to'] . '" />';
