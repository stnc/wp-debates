...
?>
<header id="header" class="header-corporate header-15<?php echo empty( $porto_settings['logo-overlay'] ) || empty( $porto_settings['logo-overlay']['url'] ) ? '' : ' logo-overlay-header'; ?>">
	...
	<div class="header-main">
		<div class="container">
			...
			<div class="header-right">
				...
				<?php echo porto_mobile_toggle_icon(); ?>
			</div>
		</div>
