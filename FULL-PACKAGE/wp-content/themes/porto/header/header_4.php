...
?>
<header id="header" class="header-separate header-4 logo-center sticky-menu-header<?php echo empty( $porto_settings['logo-overlay'] ) || empty( $porto_settings['logo-overlay']['url'] ) ? '' : ' logo-overlay-header'; ?>">
