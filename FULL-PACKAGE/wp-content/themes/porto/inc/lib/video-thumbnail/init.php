	...
	class Porto_Video_Thumbnail {
		...
		public function printVideoThumbnails() {
			...
			if ( $video_html ) {
				...
				?>
				<div class="img-thumbnail">
					<a href="#" class="porto-video-thumbnail-viewer popup-video"><img src="<?php echo esc_url( $poster ); ?>" alt="poster image"></a>
					<script type="text/template" class="porto-video-thumbnail-data">
						<figure class="post-media fit-video">
				...
				?>
				<div class="img-thumbnail">
					<a href="<?php echo esc_url( $video_code ); ?>" class="porto-video-thumbnail-viewer popup-<?php echo ! empty( $youtube_id ) ? 'youtube' : 'vimeo'; ?>"><img src="<?php echo esc_url( $poster ); ?>" alt="poster image"></a>
				</div>
				<?php
			}
			return ob_get_clean();
