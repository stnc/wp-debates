...
/**
 * Include Hubspot Compatibility class
 */
include_once PORTO_PLUGINS . '/compatibility/class-porto-hubspot-compatibility.php';
	...
	class PortoTGMPlugins {
		...
		protected $plugins = array(
			...
			array(
				...
				'required'   => false,
				'url'        => 'perfect-woocommerce-brands/perfect-woocommerce-brands.php',
				'image_url'  => PORTO_PLUGINS_URI . '/images/wc_brands.png',
				'visibility' => 'hidden',
			),
			array(
				'name'       => 'WPC Buy Now Button for WooCommerce',
				'slug'       => 'wpc-buy-now-button',
				'required'   => false,
				'url'        => 'wpc-buy-now-button/wpc-buy-now-button.php',
				'image_url'  => PORTO_PLUGINS_URI . '/images/buynow.png',
				'visibility' => 'hidden',
			),			
			array(
				'name'       => 'Dokan',
